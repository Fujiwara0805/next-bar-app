...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-bold leading-[1.2] ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/25 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'border border-primary bg-primary text-primary-foreground hover:bg-primary/90 active:bg-primary/80',
        destructive:
          'border border-destructive bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-border bg-transparent text-primary hover:bg-primary/10',
        secondary:
          'border border-secondary bg-secondary text-secondary-foreground hover:bg-brass-300 active:bg-warning',
        ghost: 'text-foreground/70 hover:bg-primary/10 hover:text-foreground',
