...
export const FACILITY_CATEGORIES = {
  ...
  // 終日・ランチ・ファミリー（バー以外の飲食店に対応するための汎用カテゴリ）
  daytime: {
    title: '☀️ ランチ・終日・ファミリー',
    items: ['ランチ', 'モーニング', 'テイクアウト可', 'ヘルシーメニュー', 'ヴィーガン対応', '子連れ歓迎', 'キッズメニューあり', 'スイーツ充実'],
  },
  // 名物・ご当地（テーマ回遊マップ＝「からあげ回遊マップ」等の絞り込みに使う特別タグ）
  specialty: {
    title: '🏅 名物・ご当地（回遊マップ）',
    items: ['名物料理あり', 'ご当地グルメ', '特産品使用', '地元の味', 'からあげ', '海鮮料理', '焼肉', 'ラーメン', 'そば・うどん', '定食・食堂', 'B級グルメ', '地酒あり'],
  },
} as const;

// テーマ回遊マップ（マップ画面の絞り込みチップ）として提示する特別タグ。
// FACILITY_CATEGORIES.specialty.items のうち、ジャンル性が高く回遊テーマになりやすいもの。
export const THEME_MAP_TAGS = [
  '名物料理あり', 'ご当地グルメ', 'からあげ', '海鮮料理', '焼肉', 'ラーメン', 'そば・うどん', '定食・食堂', 'スイーツ充実', 'ランチ',
] as const;
