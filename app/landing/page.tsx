      ...
      <header className="fixed top-0 left-0 right-0 z-50 safe-top" style={{ background: lpPage.bg, backdropFilter: 'blur(20px)', borderBottom: `1px solid ${lpPage.border}` }}>
        <div className="container mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3 min-w-0">
            ...
            >
              <img
                src="https://res.cloudinary.com/dz9trbwma/image/upload/f_auto,q_auto,c_scale,w_120/v1782798987/ChatGPT_Image_2026%E5%B9%B46%E6%9C%8830%E6%97%A5_14_54_57_tjuisz.png"
                alt="NIKENME+"
          ...
          <>
            ...
            <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} exit={{ x: '100%' }} transition={{ type: 'spring', damping: 25, stiffness: 200 }} className="fixed right-0 top-0 bottom-0 w-80 z-50 overflow-y-auto" style={{ background: lpPage.bg, borderLeft: `1px solid ${lpPage.border}` }}>
              <div className="p-6 pt-20">
                ...
                >
                  <img
                    src="https://res.cloudinary.com/dz9trbwma/image/upload/f_auto,q_auto,c_scale,w_180/v1782798987/ChatGPT_Image_2026%E5%B9%B46%E6%9C%8830%E6%97%A5_14_54_57_tjuisz.png"
                    alt="NIKENME+"
      ...
      <footer className="py-12 px-4" style={{ background: lpPage.bg }}>
        <div className="container mx-auto max-w-6xl">
          <div className="flex justify-center mb-8">
            <img src="https://res.cloudinary.com/dz9trbwma/image/upload/f_auto,q_auto,c_scale,w_144/v1782798987/ChatGPT_Image_2026%E5%B9%B46%E6%9C%8830%E6%97%A5_14_54_57_tjuisz.png" alt="NIKENME+" className="h-12 w-auto object-contain opacity-70" />
          </div>
