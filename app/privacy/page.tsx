...
export default function PrivacyPage() {
  ...
  const sections = [
    { title: t('privacy_page.section1_title'), content: t('privacy_page.section1_content'), items: [t('privacy_page.section1_item1'), t('privacy_page.section1_item2'), t('privacy_page.section1_item3'), t('privacy_page.section1_item4')] },
    { title: t('privacy_page.section2_title'), content: t('privacy_page.section2_content'), items: [t('privacy_page.section2_item1'), t('privacy_page.section2_item2'), t('privacy_page.section2_item3'), t('privacy_page.section2_item4'), t('privacy_page.section2_item5')] },
    { title: t('privacy_page.section3_title'), content: t('privacy_page.section3_content'), items: [t('privacy_page.section3_item1'), t('privacy_page.section3_item2'), t('privacy_page.section3_item3')] },
    { title: t('privacy_page.section4_title'), content: t('privacy_page.section4_content') },
    { title: t('privacy_page.section5_title'), content: t('privacy_page.section5_content') },
    { title: t('privacy_page.section6_title'), content: t('privacy_page.section6_content') },
    { title: t('privacy_page.section7_title'), content: t('privacy_page.section7_content') },
    { title: t('privacy_page.section8_title'), content: t('privacy_page.section8_content') },
  ];
      ...
      >
        <div className="text-center mb-10">
          ...
          >
            ...
            <span className="text-xs font-medium tracking-widest uppercase" style={{ color: COLORS.accent }}>Privacy</span>
          </motion.div>
          <h1 className="text-3xl sm:text-4xl font-bold" style={{ color: COLORS.text }}>{t('privacy_page.title')}</h1>
        </div>
        ...
        <div className="mt-10 pt-6 text-right" style={{ borderTop: `1px solid ${COLORS.borderGold}` }}>
          <p className="text-xs" style={{ color: COLORS.textSubtle }}>
            {t('privacy_page.established_date')}<br />{t('privacy_page.last_updated')}
          </p>
        </div>
      </motion.main>
    </div>
