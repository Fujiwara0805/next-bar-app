...
## 1. コアパレット — "Brewer's Navy" トーン（確定版 2026-04-23）

ユーザー確定のブランド3色: **Brewer Navy `#13294b` / Yellow `#ffc82c` / Off-white `#F7F3E9`**。ネイビーを主軸に、イエローをハイライト、オフホワイトを暖かみのある文字色として使う。

| トークン | HEX | HSL (`H S L`) | 用途 |
|---|---|---|---|
| **Brewer Navy 950** | `#071022` | `216 60% 7%` | 深いヘッダー背景・暗いオーバーレイ |
| **Brewer Navy 900**（Base） | `#0B1930` | `216 60% 11%` | `--background`（ダーク基調面） |
| **Brewer Navy 800** | `#10233D` | `216 55% 15%` | セクション区切り・`--card`（ダーク） |
| **Brewer Navy 700**（Primary） | `#13294b` | `216 60% 18%` | `--primary` — ボタン、強調 |
| **Brewer Navy 600** | `#20385F` | `216 50% 25%` | ホバー・アクティブ |
| **Brewer Navy 500** | `#335280` | `216 45% 35%` | リンク、フォーカスリング |
| **Brewer Navy 300** | `#90A4C1` | `216 35% 65%` | ダーク上の副次テキスト |
| **Brewer Navy 100** | `#E1E8F3` | `216 45% 92%` | ライト背景 |

### アクセント（暖色）

| トークン | HEX | HSL | 用途 |
|---|---|---|---|
| **Brass 500**（Secondary = Yellow） | `#ffc82c` | `44 100% 59%` | `--secondary` — CTA・バッジ・アクセント |
| **Brass 300** | `#ffdf85` | `44 100% 75%` | ソフトイエロー、ハイライト |
...
```css
:root {
  /* Brewer Navy palette — 確定版 (primary=#13294b / yellow=#ffc82c) */
  --bn-950: 216 60% 7%;
  --bn-900: 216 60% 11%;
  --bn-800: 216 55% 15%;
  --bn-700: 216 60% 18%;
